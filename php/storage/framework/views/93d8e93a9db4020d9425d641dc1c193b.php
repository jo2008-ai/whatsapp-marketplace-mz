            ...
            <form method="POST" action="/registar">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="nome_loja" value="<?php echo e(old('nome_loja')); ?>" required
                    ...
                    <div>
                        ...
                        <input type="text" name="telefone" value="<?php echo e(old('telefone')); ?>"
                            class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                    ...
                    <div>
                        ...
                        <select name="plano" required class="w-full px-3 py-2 border rounded-lg"
                            ...
                            <option value="basic" <?php echo e(old('plano') === 'basic' ? 'selected' : ''); ?>>Basic — 500 MZN/mês</option>
                            <option value="pro" <?php echo e(old('plano') === 'pro' ? 'selected' : ''); ?>>Pro — 1.500 MZN/mês</option>
                            <option value="enterprise" <?php echo e(old('plano') === 'enterprise' ? 'selected' : ''); ?>>Enterprise — Sob consulta</option>
                        </select>
                    </div>
...
<?php /**PATH /home/mozdv/projectos/whatsapp-marketplace-saas/php/resources/views/publico/registar.blade.php ENDPATH**/ ?>