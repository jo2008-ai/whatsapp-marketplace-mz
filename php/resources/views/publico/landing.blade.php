...
<head>
    ...
    <title>WhatsApp Marketplace</title>
...
<body class="bg-white">
        ...
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <p class="text-gray-600">Escaneia o QR code com o teu WhatsApp.</p>
                </div>
                <div class="text-center">
                ...
                <div class="text-center">
                    ...
                    <p class="text-gray-600">Clientes enviam "Olá" → bot mostra catálogo → fazem encomenda.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 bg-blue-600 text-white text-center">
        <div class="max-w-3xl mx-auto px-4">
            ...
            <p class="text-blue-100 text-lg mb-8">Configuração em 5 minutos.</p>
